...
const Footer = () => {
  const footerLinks = {
    ...
    community: {
      title: "Community",
      links: [
        { name: "Discord", href: "https://discord.gg", src: "/assets/discord.png" },
        { name: "Twitter", href: "https://twitter.com", src: "/assets/twitter.png" },
        { name: "Telegram", href: "https://telegram.org", src: "/assets/telegram.png" },
      ],
    },
  };
            ...
            <div className="flex space-x-4">
              {Object.values(footerLinks.community.links).map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  className="w-10 h-10 rounded-lg  flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#644881] transition-all"
                >
